...
/**
 * Defines the labor categories defined in a filter.
 */
public class FilterLaborCategory implements Comparable<FilterLaborCategory> {
    @Nonnull
    ...
    /**
     * Retrieve the unique id of this labor category filter.
     *
     * @return the unique id of this labor category filter
     */
    @Nonnull
    public String getId() {
        return this.id;
    ...
    @Override
    public int compareTo(@Nullable final FilterLaborCategory other) {
        if (other == null) {
            return 1;
        }
    ...
    public boolean equals(@CheckForNull final Object other) {
        return other instanceof FilterLaborCategory && compareTo((FilterLaborCategory) other) == 0;
    }
