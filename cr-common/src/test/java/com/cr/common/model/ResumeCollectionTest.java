...
public class ResumeCollectionTest {
    ...
    public void testParameterConstructor() {
        final Resume resume1 = new Resume("id-1", "uid-1", ResumeStatus.UNPUBLISHED, LocalDateTime.now(), null);
    ...
    public void testHashCode() {
        ...
        final Resume resume1 = new Resume("id-1", "uid-1", ResumeStatus.UNPUBLISHED, created, expires);
        final Resume resume2 = new Resume("id-2", "uid-2", ResumeStatus.PUBLISHED, created, expires);
        final ResumeCollection resumeColl = new ResumeCollection(Arrays.asList(resume1, resume2));
        assertEquals(-495232306, resumeColl.hashCode());
    }
    ...
    public void testToString() {
        ...
        final ResumeCollection resumeColl = new ResumeCollection(Arrays.asList(resume1, resume2));
        assertEquals(
                "ResumeCollection[resumes=[Resume[id=id-1,userId=uid-1,status=UNPUBLISHED,"
