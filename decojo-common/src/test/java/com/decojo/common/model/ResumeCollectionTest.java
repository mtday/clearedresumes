...
public class ResumeCollectionTest {
    ...
    public void testParameterConstructor() {
        final Resume resume1 =
                new Resume("id-1", "uid-1", ResumeStatus.IN_PROGRESS, LocalDateTime.now(), null, "lcat", 10, "obj");
        final Resume resume2 =
                new Resume("id-2", "uid-2", ResumeStatus.PUBLISHED, LocalDateTime.now(), null, "lcat", 10, "obj");
    ...
    public void testHashCode() {
        ...
        final Resume resume1 =
                new Resume("id-1", "uid-1", ResumeStatus.IN_PROGRESS, created, expires, "lcat", 10, "obj");
        final Resume resume2 = new Resume("id-2", "uid-2", ResumeStatus.PUBLISHED, created, expires, "lcat", 10, "obj");
        final ResumeCollection resumeColl = new ResumeCollection(Arrays.asList(resume1, resume2));
        assertEquals(-1646748182, resumeColl.hashCode());
    }
    ...
    public void testToString() {
        ...
        final Resume resume2 = new Resume("id-2", "uid-2", ResumeStatus.PUBLISHED, created, expires, "lcat", 10, "obj");
        final ResumeCollection resumeColl = new ResumeCollection(Arrays.asList(resume1, resume2));
        assertEquals("ResumeCollection[resumes=[Resume[id=id-1,userId=uid-1,status=IN_PROGRESS,"
                + "created=2016-01-01T02:03:04,expiration=2016-01-01T03:04:05,laborCategory=lcat,"
                + "experience=10,objective=obj], Resume[id=id-2,userId=uid-2,status=PUBLISHED,"
                + "created=2016-01-01T02:03:04,expiration=2016-01-01T03:04:05,laborCategory=lcat,"
                + "experience=10,objective=obj]]]", resumeColl.toString());
    }
}
