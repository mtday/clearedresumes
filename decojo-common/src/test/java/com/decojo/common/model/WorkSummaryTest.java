...
public class WorkSummaryTest {
    ...
    public void testDefaultConstructor() {
        ...
        assertEquals("", workSummary.getResponsibilities());
        assertEquals("", workSummary.getAccomplishments());
    }
    ...
    public void testParameterConstructor() {
        ...
        final WorkSummary workSummary = new WorkSummary("id", "rid", "title", "emp", begin, end, "resp", "acc");
        ...
        assertEquals("resp", workSummary.getResponsibilities());
        assertEquals("acc", workSummary.getAccomplishments());
    }
    ...
    public void testCompareTo() {
        ...
        final WorkSummary a = new WorkSummary("id-1", "rid-1", "title-1", "emp-1", begin, end, "resp-1", "acc-1");
        final WorkSummary b = new WorkSummary("id-1", "rid-1", "title-1", "emp-2", begin, end, "resp-1", "acc-1");
        final WorkSummary c = new WorkSummary("id-1", "rid-1", "title-2", "emp-1", begin, end, "resp-1", "acc-1");
        final WorkSummary d = new WorkSummary("id-1", "rid-2", "title-1", "emp-1", begin, end, "resp-1", "acc-1");
        final WorkSummary e = new WorkSummary("id-2", "rid-1", "title-1", "emp-1", begin, end, "resp-1", "acc-1");
    ...
    public void testHashCode() {
        final LocalDate begin = LocalDate.of(2016, 1, 1);
        final LocalDate end = LocalDate.of(2016, 12, 31);
        assertEquals(2025027706, new WorkSummary("id", "rid", "title", "emp", begin, end, "resp", "acc").hashCode());
    }
    ...
    public void testToString() {
        ...
        assertEquals(
                "WorkSummary[id=id,resumeId=rid,jobTitle=title,employer=emp,beginDate=2016-01-01,endDate=2016-12-31,"
                        + "responsibilities=resp,accomplishments=acc]",
                new WorkSummary("id", "rid", "title", "emp", begin, end, "resp", "acc").toString());
    }
}
