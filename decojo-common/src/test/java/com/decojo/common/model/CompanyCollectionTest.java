...
public class CompanyCollectionTest {
    ...
    public void testParameterConstructor() {
        final Company company1 = new Company("id-1", "name-1", "http://website1.com/");
        final Company company2 = new Company("id-2", "name-2", "http://website2.com/");
    ...
    public void testHashCode() {
        ...
        final Company company2 = new Company("id-2", "name-2", "http://website2.com/");
        final CompanyCollection companyColl = new CompanyCollection(Arrays.asList(company1, company2));
        assertEquals(-689927368, companyColl.hashCode());
    }
    ...
    public void testToString() {
        ...
        final Company company2 = new Company("id-2", "name-2", "http://website2.com/");
        final CompanyCollection companyColl = new CompanyCollection(Arrays.asList(company1, company2));
        assertEquals("CompanyCollection[companies=[Company[id=id-1,name=name-1,website=http://website1.com/], "
                + "Company[id=id-2,name=name-2,website=http://website2.com/]]]", companyColl.toString());
    }
}
