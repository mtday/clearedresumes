...
public class CompanyAdminControllerIT {
    ...
    public void test() {
        ...
        final Company toAdd = new Company("ignored", "Company Name", "https://company-website.com");
        ...
        final Company toUpdate = new Company("ignored", "New Company Name", "https://updated-website.com");
